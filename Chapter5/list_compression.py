...
# file: list_compression.py
#    Created:       <2021/07/10 00:03:56>
#    Last Modified: <2021/07/10 16:00:37>
...
PEOPLE: List[str] = ["Michael", "Sarah",  "Joshua", "Narine", "David", "Sajid",
                     "Malanie", "Daniel", "Wei",    "Dean",   "Brian", "Murat",
                     "Lisa"]
...
class ListCompression(Chromosome):
    ...
    def crossover(self, other: ListCompression) \
    ...
    def mutate(self) -> None: # ふたつの場所を交換する
        idx1, idx2 = sample(range(len(self.lst)), k=2)
